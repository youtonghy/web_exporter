(() => {
  ...
  const RESOURCES = {
    ...
    en: {
      ...
      "option.markdown": "Markdown",
      "option.png": "PNG",
      "option.debug_package": "Debug package",
    ...
    ja: {
      ...
      "option.markdown": "Markdown",
      "option.png": "PNG",
      "option.debug_package": "デバッグパッケージ",
    ...
    es: {
      ...
      "option.markdown": "Markdown",
      "option.png": "PNG",
      "option.debug_package": "Paquete de depuración",
    ...
    de: {
      ...
      "option.markdown": "Markdown",
      "option.png": "PNG",
      "option.debug_package": "Debug-Paket",
    ...
    fr: {
      ...
      "option.markdown": "Markdown",
      "option.png": "PNG",
      "option.debug_package": "Paquet de débogage",
